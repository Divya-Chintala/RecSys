...
feature_list = pickle.load(open(r"C:\Users\divya\Documents\GitHub\RecSys\Fashion_product_Recommender\embiddings.pkl",'rb'))
filenames = pickle.load(open(r"C:\Users\divya\Documents\GitHub\RecSys\Fashion_product_Recommender\filenames.pkl",'rb'))
# print("\n*************************\n")
...
imag = image.load_img(r"C:\Users\divya\Desktop\RecSys\RecSys\Fashion-product-recommender-main\data\shoe.jpg", target_size=(224, 224))
